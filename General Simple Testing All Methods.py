...
HINT = orngCI.HINT(name="HINT")

learners = [sop,tree,bayes,svmrbf,svmpolynomial,svmlinear,HINT]#svmrbf, sop, svmpolynomial, adjustedbayes, bayes, svmlinear, adjustedsop, tree, adjustedtree, HINT

# compute accuracies on data
data = orange.ExampleTable("testing simple data.tab")
